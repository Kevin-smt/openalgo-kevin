...
def init_db():
    ...
    # because the error message for "column already exists" varies across databases.
    try:
        ...
        logger.error(
            ...
            f"the column is added. Run the PostgreSQL migration to add the column "
